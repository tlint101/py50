...
st.markdown(
    "Further information for py50 can be found on the GitHub repository [here](%s)."
    % github
)
st.markdown("Documentation can be found [here](%s)." % documentation)
st.markdown(
    "If you are interested in citing py50, you are welcome to use the zenodo link [here](%s)."
    % zenodo
)
